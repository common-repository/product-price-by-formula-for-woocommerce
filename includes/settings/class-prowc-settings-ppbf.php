...
class ProWC_Settings_PPBF extends WC_Settings_Page {
	...
	function __construct() {
		$this->id    = 'prowc_ppbf';
		$this->label = __( 'Product Price by Formula', 'product-price-by-formula-for-woocommerce' );
		parent::__construct();
	...
	function get_settings() {
		...
		return array_merge( apply_filters( 'woocommerce_get_settings_' . $this->id . '_' . $current_section, array() ), array(
			array(
				'title'     => __( 'Reset Settings', 'product-price-by-formula-for-woocommerce' ),
				'type'      => 'title',
				'id'        => $this->id . '_' . $current_section . '_reset_options',
			),
			array(
				'title'     => __( 'Reset section settings', 'product-price-by-formula-for-woocommerce' ),
				'desc'      => '<strong>' . __( 'Reset', 'product-price-by-formula-for-woocommerce' ) . '</strong>',
	...
	function admin_notice_settings_reset() {
		echo '<div class="notice notice-warning is-dismissible"><p><strong>' .
			esc_html__( 'Your settings have been reset.', 'product-price-by-formula-for-woocommerce' ) . '</strong></p></div>';
	}
